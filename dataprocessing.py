...
# 可视化数据
    ...
    plt.show()
    # 保存为第一个PDF
    pdf_path_1 = r"E:\AI\Anaconda3\A\envs\FirstDL\ShuiWeiC\plot_1.pdf"
    plt.savefig(pdf_path_1)
    plt.close()
    ...
    plt.show()
    # 保存为第一个PDF
    pdf_path_2 = r"E:\AI\Anaconda3\A\envs\FirstDL\ShuiWeiC\plot_2.pdf"
    plt.savefig(pdf_path_2)
    plt.close()
    ...
    plt.show()
    # 保存为第一个PDF
    pdf_path_3 = r"E:\AI\Anaconda3\A\envs\FirstDL\ShuiWeiC\plot_3.pdf"
    plt.savefig(pdf_path_3)
    plt.close()
    ...
    plt.show()
    # 保存为第一个PDF
    pdf_path_4 = r"E:\AI\Anaconda3\A\envs\FirstDL\ShuiWeiC\plot_4.pdf"
    plt.savefig(pdf_path_4)
    plt.close()
"""